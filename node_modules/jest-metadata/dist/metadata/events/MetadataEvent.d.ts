...
export type MetadataEvent = SetupEvent | AddHookEvent | AddTestEvent | FinishDescribeDefinitionEvent | HookFailureEvent | HookStartEvent | HookSuccessEvent | RunDescribeFinishEvent | RunDescribeStartEvent | RunFinishEvent | RunStartEvent | WriteMetadataEvent | StartDescribeDefinitionEvent | TestDoneEvent | AddTestFileEvent | TestFnFailureEvent | TestFnStartEvent | TestFnSuccessEvent | TestRetryEvent | TestSkipEvent | TestStartEvent | TestStartedEvent | TestTodoEvent;
